...
3. Добавлен модуль generators с примерами использования
4. Добавлен модуль decorators, который записывает логи работы функции
5. Добавлена возможность считывания операций CSV- и XLSX-файлов.